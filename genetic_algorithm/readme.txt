...
P.S. Initially, it was supposed to be implemented in Pascal, but at the end of the second semester they were given the task to rewrite some procedures in assembler, 
which made it possible to perform these procedures on average 10 times faster.
