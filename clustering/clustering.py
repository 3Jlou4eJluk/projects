...
алгоритм получает на вход максимальное количество итераций, число epsilon, максимальное число итераций с максимальным
смещением центров, не превыщающим epsilon
при подсчёте расстояний будем сохранять их в
"""
